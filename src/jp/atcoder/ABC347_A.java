...
public class ABC347_A {
	...
	private static void aDivisible(ArrayList<Integer> il1, ArrayList<Integer> il2) {
		String ans = "";
		int numToDivide = il1.get(1);
		for(int i=0;i<il2.size();i++) {
			if(il2.get(i) % numToDivide == 0) {
				ans += il2.get(i) / numToDivide + " ";
			}
		}
